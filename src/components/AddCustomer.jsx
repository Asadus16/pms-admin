...
function AddCustomer({ onClose }) {
  ...
  const [selectedTags, setSelectedTags] = useState(['Login with Shop']);
  const availableTags = [
    'password page',
    'Pop Convert',
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .add-customer-wrapper .Polaris-Card {
            border-radius: 0 !important;
            padding-left: 16px !important;
            margin-left: 0 !important;
          }
          
          .add-customer-wrapper .Polaris-Card__Section {
            padding-left: 0 !important;
            margin-left: 0 !important;
          }
          
          .add-customer-wrapper .Polaris-BlockStack {
            padding-left: 0 !important;
            margin-left: 0 !important;
          }
        }
      ...
      <div className="add-customer-wrapper">
        <Page
          backAction={{ content: 'Customers', onAction: handleBack }}
          title={
